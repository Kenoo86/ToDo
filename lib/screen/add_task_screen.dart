...
class _AddTaskScreenState extends State<AddTaskScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    //Tasks _tasks = Provider.of(context);
    ...
    (arg != null)
        ? _timeController =
            TextEditingController(text: _task.time.format(context))
        : Null;
    (arg != null)
        ? _dateController =
            TextEditingController(text: DateFormat.yMMMd().format(_task.date))
        : Null;
    return Scaffold(
      appBar: AppBar(
        title: (arg == null) ? Text('Add Task') : Text('Edit Task'),
      ),
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            ElevatedButton(
                ...
                child: (arg == null) ? Text('Add Task') : Text('Edit Task'))
          ],
        ),
      ),
    );
